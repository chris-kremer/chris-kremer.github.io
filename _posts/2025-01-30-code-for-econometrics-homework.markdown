...
<div style="margin-bottom: 1rem;">
  ...
  <a href="{{ site.baseurl }}/ols_minimal.R" download style="padding: 0.5rem 1rem; text-decoration: none; background: #f4f4f4; border: 1px solid #ddd; color: #333;">Download R File</a>
</div>
